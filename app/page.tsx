...
const basePath = '/kolo-mee-stinablis-1775546286600';
...
export default function Home() {
  ...
  const products = [{ n: 'Mee Kolo Putih', d: 'Our signature Mee Kolo Putih is a traditional Sarawakian dish made with tender noodles, flavorful sauce, and a hint of garlic, served with a side of juicy chicken or pork. This dish is a must-try for any kolo mee enthusiast.', i: 'https://images.pexels.com/photos/15573468/pexels-photo-15573468.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Mee Kolo Merah', d: 'Our Mee Kolo Merah is a spicy twist on the classic dish, infused with a rich and savory tomato-based sauce, topped with succulent chicken or beef and a sprinkle of chopped scallions.', i: 'https://images.pexels.com/photos/8395783/pexels-photo-8395783.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Mee Kolo Kicap', d: 'Our Mee Kolo Kicap is a unique variation of the dish, featuring a sweet and savory soy sauce-based sauce, served with a side of crispy fried shallots and a sprinkle of chopped cilantro.', i: 'https://images.pexels.com/photos/17951969/pexels-photo-17951969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Wantan', d: 'Our Wantan is a delicious and flavorful dumpling dish, filled with a mixture of pork and shrimp, served in a light and savory broth, garnished with chopped scallions and a sprinkle of soy sauce.', i: 'https://images.pexels.com/photos/1395319/pexels-photo-1395319.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Mee Pok', d: 'Our Mee Pok is a hearty and comforting dish, featuring flat noodles served in a rich and flavorful pork or chicken broth, topped with sliced pork, boiled egg, and a sprinkle of chopped scallions.', i: 'https://images.pexels.com/photos/35001779/pexels-photo-35001779.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Kolo mee stinablis is a reputable food establishment dedicated to serving high-quality kolo mee dishes to our valued customers. With a strong commitment to excellence, we strive to provide an exceptional dining experience that exceeds our customers\' expectations. Our team of skilled chefs and staff are passionate about delivering the best kolo mee in town.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading kolo mee brand in the region, renowned for our delicious and authentic dishes, exceptional customer service, and unwavering commitment to quality.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide our customers with the most delicious and satisfying kolo mee experience, while fostering a culture of excellence, innovation, and customer-centricity within our organization.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer First</h4>
                  <p className="text-sm text-on-surface-variant">At Kolo mee stinablis, we prioritize our customers\' needs and preferences, striving to deliver personalized service and ensuring that every customer leaves our establishment feeling valued and satisfied.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Quality</h4>
                  <p className="text-sm text-on-surface-variant">We are dedicated to serving only the highest-quality kolo mee dishes, made with the freshest ingredients and cooked to perfection, to consistently meet and exceed our customers\' expectations.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/33986701/pexels-photo-33986701.png?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/21319355/pexels-photo-21319355.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/8093607/pexels-photo-8093607.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
